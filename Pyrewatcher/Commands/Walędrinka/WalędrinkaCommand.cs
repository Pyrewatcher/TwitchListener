...
{
  public class WalędrinkaCommand : CommandBase<WalędrinkaCommandArguments>
  {
    ...
    public override WalędrinkaCommandArguments ParseAndValidateArguments(List<string> argsList, ChatMessage message)
    {
      return new WalędrinkaCommandArguments();
    }

    public override Task<bool> ExecuteAsync(WalędrinkaCommandArguments args, ChatMessage message)
    {
