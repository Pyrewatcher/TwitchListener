...
{
  public class AhCommand : CommandBase<AhCommandArguments>
  {
    ...
    public override AhCommandArguments ParseAndValidateArguments(List<string> argsList, ChatMessage message)
    {
      if (argsList.Count == 0)
      {
    ...
    public override Task<bool> ExecuteAsync(AhCommandArguments args, ChatMessage message)
    {
