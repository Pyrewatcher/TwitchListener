...
{
  public class ChannelsCommand : CommandBase<ChannelsCommandArguments>
  {
    ...
    public override ChannelsCommandArguments ParseAndValidateArguments(List<string> argsList, ChatMessage message)
    {
      return new ChannelsCommandArguments();
    }

    public override async Task<bool> ExecuteAsync(ChannelsCommandArguments args, ChatMessage message)
    {
