...
{
  public class ArdentCommand : CommandBase<ArdentCommandArguments>
  {
    ...
    public override ArdentCommandArguments ParseAndValidateArguments(List<string> argsList, ChatMessage message)
    {
      return new ArdentCommandArguments();
    }

    public override async Task<bool> ExecuteAsync(ArdentCommandArguments args, ChatMessage message)
    {
