...
{
  public class DisconnectCommand : CommandBase<DisconnectCommandArguments>
  {
    ...
    public override DisconnectCommandArguments ParseAndValidateArguments(List<string> argsList, ChatMessage message)
    {
    ...
    public override async Task<bool> ExecuteAsync(DisconnectCommandArguments args, ChatMessage message)
    {
